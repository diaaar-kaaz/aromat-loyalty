      ...
      <div className="mx-auto max-w-2xl">
        ...
        <Section title="1. Какие данные мы собираем">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Токен устройства для push-уведомлений — только если вы разрешили уведомления. Это
              техническая строка от Apple, она не содержит ваших личных данных.
            </li>
          </ul>
          <p className="mt-3">
            Мы не собираем платёжные данные, геолокацию, контакты, рекламные идентификаторы и не
            отслеживаем вас в других приложениях и сайтах.
          </p>
        </Section>
        ...
        <Section title="2. Зачем мы используем данные">
          ...
          <p className="mt-3">
            Если вы разрешили уведомления, мы присылаем короткие сообщения о свежей выпечке и акциях
            пекарни. Отключить их можно в любой момент: переключатель «Уведомления о свежей выпечке»
            в личном кабинете приложения или настройки уведомлений на вашем устройстве.
          </p>
        </Section>
